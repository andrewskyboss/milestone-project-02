function initMap() {
	...
	const destinationsPrimary = [
		[{ lat: 53.031401, lng: -8.056747 },
			// '<img class="marker-img" src="assets/images/travel-ireland-004.jpg">'
			'Ireland',
			...
			'<a href="#ireland">Our Packages</a><br><br>', 
		...
		[{ lat: 50.725340, lng: 10.286539 }, 
			...
			'<a href="#germany">Our Packages</a><br><br>', 
		...
		[{ lat: 46.854619, lng: 2.316878 }, 
			...
			'<a href="#france">Our Packages</a><br><br>', 
		...
		[{ lat: 42.375270, lng: 13.108583 }, 
			...
			'<a href="#italy">Our Packages</a><br><br>', 
		...
		[{ lat: 40.812041, lng: -3.823681 },
			...
			'<a href="#spain">Our Packages</a><br><br>', 
