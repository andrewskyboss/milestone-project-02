...
function initMap() {
	...
	const destinationsPrimary = [
		[{ lat: 53.031401, lng: -8.056747 },
			...
			'<a onclick="unhideModule(\'ireland\')" class="btn btn-secondary" href="#ireland">Our Packages</a><br><br>', 
		...
		[{ lat: 50.725340, lng: 10.286539 }, 
			...
			'<a onclick="unhideModule(\'germany\')" class="btn btn-secondary" href="#germany">Our Packages</a><br><br>', 
		...
		[{ lat: 46.854619, lng: 2.316878 }, 
			...
			'<a onclick="unhideModule(\'france\')" class="btn btn-secondary" href="#france">Our Packages</a><br><br>', 
		...
		[{ lat: 42.375270, lng: 13.108583 }, 
			...
			'<a onclick="unhideModule(\'italy\')" class="btn btn-secondary" href="#italy">Our Packages</a><br><br>', 
		...
		[{ lat: 40.812041, lng: -3.823681 },
			...
			'<a onclick="unhideModule(\'spain\')" class="btn btn-secondary" href="#spain">Our Packages</a><br><br>', 
